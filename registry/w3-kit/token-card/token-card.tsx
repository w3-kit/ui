...
import { ExtendedToken, TokenCardProps } from "./types";
import { formatBalance, formatCurrency, formatDate, animationStyles } from "./utils";
...
export const TokenCard: React.FC<TokenCardProps> = ({
  ...
  const logoURI = token.logoURI || "/placeholder-token.png";
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-1 relative">
                ...
                {showDropdown && (
                  <div
                    ref={dropdownRef}
                    className="absolute top-full right-0 mt-1 w-52 bg-white dark:bg-gray-800 shadow-lg rounded-md border border-gray-200 dark:border-gray-700 z-10 overflow-hidden animate-fadeIn"
              ...
              <div className="mt-2 w-full">
                ...
                <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-1.5">
                  <div
                    ...
                    style={{
                      width: `${Math.min(Math.abs(token.priceChange24h * 2), 100)}%`,
                    }}
                  ></div>
                </div>
              </div>
