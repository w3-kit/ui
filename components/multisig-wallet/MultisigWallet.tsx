    ...
    <div className={`bg-white rounded-lg border shadow-sm ${className}`}>
      ...
      <div className="p-6 border-b">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-xl font-semibold">Multi-Signature Wallet</h2>
          ...
          <div className="text-right">
            <div className="text-sm text-gray-500">Required Approvals</div>
            <div className="text-2xl font-semibold">{requiredApprovals}/{signers.length}</div>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 py-4 border-b bg-gray-50">
        <h3 className="text-sm font-medium mb-3">Signers</h3>
      ...
      <div className="p-6">
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            ...
            className="inline-flex items-center px-3 py-1.5 bg-black text-white rounded
      ...
      {isProposing && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
          <div 
            className="bg-white rounded-lg w-full max-w-md mx-4 shadow-2xl animate-in fade-in duration-200"
