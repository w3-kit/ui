...
export const ContractInteraction: React.FC<ContractInteractionProps> = ({ className = "" }) => {
    ...
    async (e: React.FormEvent) => {
      ...
      try {
        ...
        const mockResult: ResultType = {
          ...
          hash:
            selectedFunction.type === "write" ? "0x" + Math.random().toString(16).slice(2, 42) : "",
          from:
            selectedFunction.type === "write" ? "0x" + Math.random().toString(16).slice(2, 42) : "",
          to:
            selectedFunction.type === "write" ? "0x" + Math.random().toString(16).slice(2, 42) : "",
          gasUsed:
            selectedFunction.type === "write" ? Math.floor(Math.random() * 100000).toString() : "0",
          status:
          ...
          <div>
            ...
            <div className="flex items-center mt-2 space-x-2">
              ...
              <div className="group cursor-pointer transition-transform duration-200 hover:scale-[1.02]">
                <code
                  className="text-sm bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded dark:text-gray-300
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-6">
          {filteredFunctions.map((fn) => (
            ...
            >
              <div
                className="font-medium dark:text-white group-hover:text-blue-600 
              ...
              {paginatedResults.map((result) => (
                ...
                >
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-xs text-gray-500 dark:text-gray-400">{result.time}</span>
                  </div>

                  <div
                    className="mt-1 text-sm text-gray-600 dark:text-gray-400 font-mono break-all
